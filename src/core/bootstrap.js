(function () {
  ...
  const editUserCompactStyle = document.createElement('style');
  editUserCompactStyle.id = 'edit-user-modal-compact-core';
  editUserCompactStyle.textContent = `#modal.editUserModalOpen .editUserTopBar{grid-template-columns:70px minmax(0,1fr) 42px!important;padding:10px 12px!important}#modal.editUserModalOpen .editUserTopBar h2{font-size:18px!important}#modal.editUserModalOpen .editUserTopBar .close,#modal.editUserModalOpen .editUserTopBar .saveUserButton{height:38px!important;min-height:38px!important;min-width:42px!important;padding:0 10px!important}#modal.editUserModalOpen .editUserFormBody{display:grid!important;gap:8px!important;padding:10px!important}#modal.editUserModalOpen .editUserPhotoRow{padding:8px!important;border:1px solid rgba(255,255,255,.08)!important;border-radius:14px!important;background:rgba(255,255,255,.035)!important;font-size:14px!important}#modal.editUserModalOpen .editUserField{display:grid!important;gap:5px!important;padding:8px!important;border:1px solid rgba(255,255,255,.08)!important;border-radius:14px!important;background:rgba(255,255,255,.035)!important}#modal.editUserModalOpen .editUserField span{font-size:12px!important;margin:0!important;color:#d0ad58!important}#modal.editUserModalOpen .editUserField input,#modal.editUserModalOpen .editUserField select,#modal.editUserModalOpen .editUserField textarea{min-height:40px!important;padding:8px 10px!important;border:1px solid rgba(255,255,255,.12)!important;border-radius:12px!important;background:#080b0e!important;font-size:16px!important;line-height:1.2!important}#modal.editUserModalOpen .editUserField textarea{min-height:70px!important;padding-top:8px!important}`;
  document.head.appendChild(editUserCompactStyle);
  ...
  function returnToEditedUserProfile(id) {
    ...
    setTimeout(() => {
      if (window.__settingsReturnSectionAfterUserEditor) {
        window.__settingsReturnSectionAfterUserProfile = window.__settingsReturnSectionAfterUserEditor;
        window.__settingsReturnSectionAfterUserEditor = '';
      }
