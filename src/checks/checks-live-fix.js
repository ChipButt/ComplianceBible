...
(function checksLiveFix(){
  ...
  style.textContent = '.checksPage .checkAreaBar .fdocArrow,.checksPage .checkDocBar .fdocArrow{transform:rotate(180deg)!important;width:22px!important;height:22px!important;display:grid!important;place-items:center!important}.checksPage .checkAreaGroup:not(.open)>.checkAreaBar .fdocArrow,.checksPage .checkDocCard:not(.open)>.checkDocBar .fdocArrow{transform:rotate(0deg)!important}.checksPage .fdocName strong,.checksPage .fdocName em{white-space:normal!important;overflow:visible!important;text-overflow:unset!important}.checksPage .correctiveActionBox{display:none!important}.checksPage .correctiveActionBox.open{display:grid!important}.checksPage .tempEvidenceGrid{display:grid!important;grid-template-columns:72px minmax(0,1fr)!important;gap:12px!important}.checksPage .tempEvidenceIcon{min-height:88px!important;border-radius:14px!important;display:grid!important;place-items:center!important;background:#11161c!important;color:#f0b84a!important;font-size:30px!important}.checksPage .tempEvidenceControls{display:grid!important;gap:10px!important}.checksPage .fileButton{display:grid!important;gap:6px!important}.checksPage .fileButton span{display:grid!important;place-items:center!important;min-height:40px!important;border-radius:12px!important;background:#b0914a!important;color:#080a0c!important;font-weight:900!important}html body .bottomNav,html body .bottomNav .navBtn:nth-child(n+5){background-color:#b0914a!important}.checksPage .checkDocFieldRow{display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;gap:10px!important;align-items:end!important}.checksPage .correctiveActionBox textarea{min-height:88px!important}@media(max-width:430px){.checksPage .checkDocFieldRow,.checksPage .tempEvidenceGrid{grid-template-columns:1fr!important}.checksPage .saveCheckInline{width:100%!important}}';
