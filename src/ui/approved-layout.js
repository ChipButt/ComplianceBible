(function () {
  ...
  css.textContent = [
    ...
    '.bottomNav{position:fixed!important;left:0!important;right:0!important;top:var(--fixed-topbar-height,74px)!important;bottom:auto!important;z-index:119!important;display:grid!important;grid-template-columns:repeat(4,1fr)!important;grid-auto-rows:42px!important;gap:0!important;padding:0!important;background:linear-gradient(180deg,#b0914a,#5f4a1c 50%,#11100c)!important;border-top:1px solid rgba(255,255,255,.16)!important;border-bottom:1px solid rgba(0,0,0,.55)!important;box-shadow:0 10px 24px rgba(0,0,0,.23)!important;backdrop-filter:none!important;overflow:visible!important}',
    '.bottomNav .navBtn{position:relative!important;overflow:visible!important;width:100%!important;min-width:0!important;height:42px!important;min-height:42px!important;border:0!important;border-right:1px solid rgba(0,0,0,.28)!important;border-bottom:1px solid rgba(255,255,255,.08)!important;border-radius:0!important;background:rgba(0,0,0,.16)!important;color:#fff8ea!important;padding:3px 2px 4px!important;display:grid!important;place-items:center!important;align-content:center!important;gap:1px!important;font-size:10px!important;font-weight:900!important;letter-spacing:.02em!important;text-transform:uppercase!important;line-height:1!important}',
