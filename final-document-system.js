...
(function () {
  if (window.__finalDocumentSystemV3) return;
  window.__finalDocumentSystemV3 = true;
  ...
  css.id = 'final-document-system-source-styles';
  css.textContent = `
    :root{--fdoc-gold:#c99a3a;--fdoc-gold2:#f0b84a;--fdoc-line:rgba(201,154,58,.38);--fdoc-dark:#030405;--fdoc-tray:#08090a;--fdoc-box:#151719;--fdoc-text:#f8f1e5;--fdoc-muted:#aaa298}
    ...
    .fdocBar{width:100%;display:grid;grid-template-columns:42px minmax(0,1fr) auto auto 26px;gap:10px;align-items:center;min-height:62px!important;padding:8px 11px!important;background:linear-gradient(180deg,rgba(23,18,10,.84),rgba(9,9,10,.98))!important;border:0!important;border-bottom:1px solid rgba(201,154,58,.34)!important;border-radius:0!important;color:var(--fdoc-text)!important;text-align:left!important;box-shadow:none!important}.fdocIcon{width:34px;height:34px;border-radius:50%;border:1px solid rgba(201,154,58,.55);display:flex;align-items:center;justify-content:center;color:var(--fdoc-gold2);background:rgba(201,154,58,.08);box-shadow:inset 0 0 0 1px rgba(0,0,0,.38),0 0 12px rgba(201,154,58,.08)}.fdocIcon svg{width:20px;height:20px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.fdocName{display:grid;min-width:0}.fdocName strong{font-size:15px;line-height:1.06;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:850;color:var(--fdoc-text)}.fdocName em{font-style:normal;color:var(--fdoc-gold2);font-size:12px;margin-top:3px}.fdocBadge{border:1px solid rgba(201,154,58,.54);border-radius:8px;padding:6px 9px;color:var(--fdoc-text);font-size:12px;font-weight:820;background:rgba(0,0,0,.28);box-shadow:inset 0 1px 0 rgba(255,255,255,.03)}.fdocBadge.ok{color:#68df8a;border-color:rgba(104,223,138,.5)}.fdocBadge.warn,.fdocBadge.danger{color:var(--fdoc-text)}.fdocDate{color:#d7cfc2;font-size:13px;white-space:nowrap}.fdocArrow{color:var(--fdoc-gold2);font-size:19px;text-align:right;line-height:1}
    .fdocPanel{padding:9px 10px 11px;background:linear-gradient(180deg,#090a0b,#050607)}.fdocPanel.closed{display:none}.fdocInstruction{margin:0 0 9px!important;color:var(--fdoc-muted)!important;font-size:12.5px!important;line-height:1.35!important}.fdocBody{display:grid;grid-template-columns:86px 1fr;gap:11px;align-items:stretch}.fdocThumb{width:82px;height:108px;border-radius:11px;border:1px solid rgba(255,255,255,.16);background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));display:flex;align-items:center;justify-content:center;overflow:hidden;color:#d9d0c2;font-weight:850;text-align:center;padding:6px;box-shadow:inset 0 0 0 1px rgba(0,0,0,.76),0 8px 15px rgba(0,0,0,.24)}.fdocThumb img{width:100%;height:100%;object-fit:cover}.fdocThumb.empty{font-size:11px;background:linear-gradient(180deg,#17191b,#101113);color:#bcb3a5}.fdocThumb.file{font-size:18px}.fdocControls{display:grid;gap:8px}.fdocUploads,.fdocMeta{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px;align-items:stretch}.fdocUploads label,.fdocSwitch,.fdocExpiry{height:46px;min-height:46px;border-radius:11px;background:linear-gradient(180deg,#181a1c,#101113);border:1px solid rgba(255,255,255,.12);display:flex;align-items:center;justify-content:center;color:var(--fdoc-text);font-weight:720;font-size:13px;padding:7px 10px;box-sizing:border-box;box-shadow:inset 0 1px 0 rgba(255,255,255,.035)}.fdocUploads label{gap:8px;white-space:nowrap}.fdocUploads svg,.fdocDateInputWrap svg{width:19px;height:19px;fill:none;stroke:var(--fdoc-gold2);stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}.fdocUploads input{position:absolute;opacity:0;width:1px;height:1px}.fdocSwitch{display:grid;grid-template-columns:minmax(0,1fr) auto;justify-content:normal;gap:8px;overflow:hidden;text-align:left}.fdocSwitchText{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0;color:var(--fdoc-text)}.fdocSwitch input{position:absolute;opacity:0}.fdocSwitchTrack{justify-self:end;width:38px;height:22px;border-radius:999px;background:#242526;position:relative;box-shadow:inset 0 0 0 1px rgba(255,255,255,.11);flex:0 0 auto}.fdocSwitchTrack:after{content:"";position:absolute;width:18px;height:18px;left:2px;top:2px;border-radius:50%;background:#8c8c8c;transition:left .15s ease,background .15s ease}.fdocSwitch input:checked+.fdocSwitchTrack{background:rgba(201,154,58,.25)}.fdocSwitch input:checked+.fdocSwitchTrack:after{left:18px;background:var(--fdoc-gold2);box-shadow:0 0 12px rgba(240,184,74,.4)}.fdocExpiry{display:grid;grid-template-columns:auto minmax(0,1fr);gap:7px;justify-content:stretch;text-align:left;overflow:hidden}.fdocExpiry>span:first-child{color:var(--fdoc-text);white-space:nowrap}.fdocDateInputWrap{display:flex;align-items:center;gap:6px;min-width:0}.fdocExpiry input{min-height:28px!important;height:28px!important;padding:0!important;font-size:12.5px!important;border:0!important;background:transparent!important;color:var(--fdoc-text)!important;width:100%;min-width:0}.fdocFull{width:100%;height:auto;border-radius:18px;background:#fff}.fdocFileBig{padding:40px;text-align:center;background:rgba(255,255,255,.06);border-radius:18px;color:var(--fdoc-text);font-weight:850}.evidenceViewerModal{max-height:88vh;overflow:auto}
  ...
  if (typeof bind === 'function' && !bind.__finalDocumentSystemV3) {
    const oldBind = bind;
    bind = function () { oldBind(); bindFinal(); };
    bind.__finalDocumentSystemV3 = true;
  }
