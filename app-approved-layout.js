  ...
  function apply() {
    ...
    if (routeName === 'documents') {
      ...
      if (hero) {
        ...
        hero.querySelectorAll('.badge').forEach(function (b) { b.remove(); });
      }
    }
  }
